...
for tr in table.find_all("tr")[1:]:
    ...
    each_row = [_BANK_NAME, old_or_new, 'SB', 'Post Office Savings Account', from_year, '', '', 'GE', to_year, '', '',
                'LE', '', '', '', general_roi, float(general_roi) + float(_senior_rate_inc)]
...
for tr in table.find_all("tr")[1:]:
    ...
    to_year = tr.find_all('td')[1].text
    general_roi = get_roi(tr.find_all('td')[2].text)
    each_row = [_BANK_NAME, old_or_new, 'RD', 'National Savings Recurring Deposit Account', from_year, '', '', 'GE',
...
for tr in table.find_all("tr")[1:]:
    ...
    each_row = [_BANK_NAME, old_or_new, 'TD', 'National Savings Time Deposit Account', from_year, '1', 'Y', 'GE',
                to_year, '1', 'Y', 'LE', '', '', '', general_roi_1,
                float(general_roi_1) + float(_senior_rate_inc)]
    appendtocsv(each_row)
    each_row = [_BANK_NAME, old_or_new, 'TD', 'National Savings Time Deposit Account', from_year, '2', 'Y', 'GE',
                to_year, '2', 'Y', 'LE', '', '', '', general_roi_2,
                float(general_roi_2) + float(_senior_rate_inc)]
    appendtocsv(each_row)
    each_row = [_BANK_NAME, old_or_new, 'TD', 'National Savings Time Deposit Account', from_year, '3', 'Y', 'GE',
                to_year, '3', 'Y', 'LE', '', '', '', general_roi_3,
                float(general_roi_3) + float(_senior_rate_inc)]
    appendtocsv(each_row)
    each_row = [_BANK_NAME, old_or_new, 'TD', 'National Savings Time Deposit Account', from_year, '5', 'Y', 'GE',
...
for tr in table.find_all("tr")[1:]:
    ...
    to_year = tr.find_all('td')[1].text
    general_roi = get_roi(tr.find_all('td')[2].text)
    each_row = [_BANK_NAME, old_or_new, 'MIS', 'National Savings Monthly Income Account', from_year, '', '', 'GE',
                to_year, '', '', 'LE', '', '', '', general_roi,
                float(general_roi) + float(_senior_rate_inc)]
    appendtocsv(each_row)
table = all_tables[4]
for tr in table.find_all("tr")[1:]:
    ...
    to_year = tr.find_all('td')[1].text
    general_roi = get_roi(tr.find_all('td')[2].text)
    each_row = [_BANK_NAME, old_or_new, 'SCSS', 'Senior Citizens Savings Scheme Account', from_year, '', '', 'GE',
                to_year, '', '', 'LE', '', '', '', general_roi,
                float(general_roi) + float(_senior_rate_inc)]
    appendtocsv(each_row)
old_or_new = 'NEW'
...
to_year = '31-03-2025'
general_roi = 4.00
each_row = [_BANK_NAME, old_or_new, 'SB', 'Post Office Savings Account', from_year, '', '', 'GE', to_year, '', '', 'LE',
            '', '', '', general_roi,
            float(general_roi) + float(_senior_rate_inc)]
appendtocsv(each_row)
...
general_roi_3 = 7.1
general_roi_5 = 7.5
each_row = [_BANK_NAME, old_or_new, 'TD', 'National Savings Time Deposit Account', from_year, '1', 'Y', 'GE', to_year,
            '1', 'Y', 'LE', '', '', '', general_roi_1,
            float(general_roi_1) + float(_senior_rate_inc)]
appendtocsv(each_row)
each_row = [_BANK_NAME, old_or_new, 'TD', 'National Savings Time Deposit Account', from_year, '2', 'Y', 'GE', to_year,
            '2', 'Y', 'LE', '', '', '', general_roi_2,
            float(general_roi_2) + float(_senior_rate_inc)]
appendtocsv(each_row)
each_row = [_BANK_NAME, old_or_new, 'TD', 'National Savings Time Deposit Account', from_year, '3', 'Y', 'GE', to_year,
            '3', 'Y', 'LE', '', '', '', general_roi_3,
            float(general_roi_3) + float(_senior_rate_inc)]
appendtocsv(each_row)
each_row = [_BANK_NAME, old_or_new, 'TD', 'National Savings Time Deposit Account', from_year, '5', 'Y', 'GE', to_year,
...
to_year = '31-03-2025'
general_roi = 7.4
each_row = [_BANK_NAME, old_or_new, 'MIS', 'National Savings Monthly Income Account', from_year, '', '', 'GE', to_year,
            '', '', 'LE', '', '', '', general_roi,
            float(general_roi) + float(_senior_rate_inc)]
appendtocsv(each_row)
from_year = '01-01-2024'
to_year = '31-03-2025'
general_roi = 8.2
each_row = [_BANK_NAME, old_or_new, 'SCSS', 'Senior Citizens Savings Scheme Account', from_year, '', '', 'GE', to_year,
            '', '', 'LE', '', '', '', general_roi,
            float(general_roi) + float(_senior_rate_inc)]
appendtocsv(each_row)
